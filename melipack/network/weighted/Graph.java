package melipack.network.weighted;

import java.util.*;

public interface Graph<Vertex, Weight> extends Iterable<Vertex> {  
//Notice the type parameter Weight
...
//Edge-related method specifications
	 ...
	 *                this Graph; otherwise, return null.
	 */
	public Weight getEdgeWeight (Vertex v1, Vertex v2);
	 ...
	 */
	public boolean addEdge (Vertex v1, Vertex v2, Weight weight);
